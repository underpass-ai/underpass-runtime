	...
	return Bundle{
		...
		Build: func(cfg Config) []tooladapter.Handler {
			return []tooladapter.Handler{
				...
				tooladapter.NewFSGlobHandler(cfg.CommandRunner),
				tooladapter.NewFSReadLinesHandler(cfg.CommandRunner),
				tooladapter.NewFSInsertHandler(cfg.CommandRunner),
				...
				tooladapter.NewWebFetchHandler(),
				tooladapter.NewWebSearchHandler(cfg.CommandRunner),
				tooladapter.NewGitHubGetIssueHandler(cfg.CommandRunner),
				tooladapter.NewRepoSymbolsHandler(cfg.CommandRunner),
				tooladapter.NewRepoTestFileHandler(cfg.CommandRunner),
				tooladapter.NewGitBlameHandler(cfg.CommandRunner),
				tooladapter.NewGitHubListIssuesHandler(cfg.CommandRunner),
				tooladapter.NewGitHubReviewCommentsHandler(cfg.CommandRunner),

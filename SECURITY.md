...
authorization layers, see **[docs/security-model.md](docs/security-model.md)**.
...
- **TLS 1.3 minimum**: Enforced on all transports (HTTP server, Valkey, NATS, S3, OTLP). See [docs/DEPLOYMENT-TLS.md](docs/DEPLOYMENT-TLS.md).
